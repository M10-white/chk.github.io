!function(n, t) {
    ...
    var n = {
        ...
        confirmButtonColor: "rgba(146, 3, 127, 0.925);",
        confirmButtonClass: null,
        cancelButtonText: "Cancel",
        cancelButtonAriaLabel: "",
        cancelButtonColor: "rgb(104, 6, 91)",
      ...
      , s = function(n, t) {
        (n = String(n).replace(/[^0-9a-f]/gi, "")).length < 6 && (n = n[0] + n[0] + n[1] + n[1] + n[2] + n[2]),
        t = t || 0;
        for (var e = "#", o = 0; o < 3; o++) {
    ...
    var b = function(n) {
        for (var t in n)
            ...
            k.isDeprecatedParameter(t) && c('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
    }
      , g = function(t) {
        ("string" == typeof t.target && !document.querySelector(t.target) || "string" != typeof t.target && !t.target.appendChild) && (r('Target parameter is not valid, defaulting to "body"'),
        t.target = "body");
        var e = void 0
          , s = B()
        ...
        for (var u = e.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), d = 0; d < u.length; d++)
        ...
        t.backdrop || D([document.documentElement, document.body], o["no-backdrop"]),
        t.text || t.html) {
            if ("object" === p(t.html))
                if (b.innerHTML = "",
                0 in t.html)
            ...
            K(b);
        if (t.position in o && D(f, o[t.position]),
        t.grow && "string" == typeof t.grow) {
            var S = "grow-" + t.grow;
            S in o && D(f, o[S])
        }
        t.showCloseButton ? (y.setAttribute("aria-label", t.closeButtonAriaLabel),
        W(y)) : K(y),
        e.className = o.popup,
        t.toast ? (D([document.documentElement, document.body], o["toast-shown"]),
        D(e, o.toast)) : D(e, o.modal),
        t.customClass && D(e, t.customClass);
        var E = q()
          , j = parseInt(null === t.currentProgressStep ? k.getQueueStep() : t.currentProgressStep, 10);
        t.progressSteps.length ? (W(E),
        _(E),
        j >= t.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        t.progressSteps.forEach(function(n, e) {
            var a = document.createElement("li");
            if (D(a, o.progresscircle),
            a.innerHTML = n,
        ...
        if (t.type) {
            ...
            if (!M)
                return i("Unknown alert type: " + t.type),
                !1;
            ...
            t.animation)
                ...
                case "success":
                    ...
                    D(I.querySelector(".swal2-success-line-tip"), "swal2-animate-success-line-tip"),
                    D(I.querySelector(".swal2-success-line-long"), "swal2-animate-success-line-long");
                    break;
                case "error":
        ...
        var X = z();
        t.imageUrl ? (X.setAttribute("src", t.imageUrl),
        X.setAttribute("alt", t.imageAlt),
        W(X),
        t.imageWidth ? X.setAttribute("width", t.imageWidth) : X.removeAttribute("width"),
        t.imageHeight ? X.setAttribute("height", t.imageHeight) : X.removeAttribute("height"),
        X.className = o.image,
        t.imageClass && D(X, t.imageClass)) : K(X),
        ...
        t.buttonsStyling && (x.style.backgroundColor = t.confirmButtonColor,
        ...
        t.buttonsStyling ? D([x, h], o.styled) : ($([x, h], o.styled),
      ...
      , k = function n() {
        ...
        if ("undefined" != typeof window) {
            if (void 0 === e[0])
                return i("SweetAlert2 expects at least 1 attribute!"),
                !1;
            var r = w({}, u);
            switch (p(e[0])) {
            case "string":
            ...
            case "object":
                ...
                break;
            default:
                return i('Unexpected type of argument! Expected "string" or "object", got ' + p(e[0])),
                !1
            }
            g(r);
            var d = A()
            ...
            return new Promise(function(t, e) {
                ...
                for (var u = function(t) {
                    if (r.showLoaderOnConfirm && n.showLoading(),
                    r.preConfirm) {
                    ...
                    case "click":
                        if (p && n.isVisible())
                            ...
                            d && n.isVisible() && (n.disableButtons(),
                            l("cancel"))
                    }
                }, v = k.querySelectorAll("button"), C = 0; C < v.length; C++)
                    v[C].onclick = b,
                    v[C].onmouseover = b,
                    v[C].onmouseout = b,
                    v[C].onmousedown = b;
                ...
                r.toast)
                    k.onclick = function(t) {
                        t.target !== k || r.showConfirmButton || r.showCancelButton || r.allowOutsideClick && (n.closePopup(r.onClose),
                        l("overlay"))
                    }
                    ;
                else {
                ...
                r.toast && m && (window.onkeydown = f,
                m = !1),
                r.toast || m || (f = window.onkeydown,
                m = !0,
                window.onkeydown = function(t) {
                    ...
                    if ("Enter" !== e.key || e.isComposing)
                        if ("Tab" === e.key) {
                            ...
                            -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === E && Q(M) ? M.focus() : document.activeElement === M && Q(E) && E.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== r.allowEscapeKey || l("esc");
                    else if (e.target === w()) {
                ...
                r.buttonsStyling && (E.style.borderLeftColor = r.confirmButtonColor,
                E.style.borderRightColor = r.confirmButtonColor),
                n.hideLoading = n.disableLoading = function() {
                    r.showConfirmButton || (K(E),
                    r.showCancelButton || K(N())),
                    $([k, P], o.loading),
                ...
                n.enableInput = function() {
                    ...
                    if (!n)
                        return !1;
                    if ("radio" === n.type)
                        for (var t = n.parentNode.parentNode.querySelectorAll("input"), e = 0; e < t.length; e++)
                            t[e].disabled = !1;
                    else
                        n.disabled = !1
                }
                ...
                n.showValidationError = function(n) {
                    ...
                    W(t);
                    var e = w();
                    e && (e.setAttribute("aria-invalid", !0),
                ...
                for (var _ = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], J = void 0, G = 0; G < _.length; G++) {
                    ...
                    tn.className = nn,
                    r.inputClass && D(tn, r.inputClass),
                    K(tn)
                }
                var sn = void 0;
                switch (r.input) {
                ...
                case "checkbox":
                    ...
                    (mn = document.createElement("span")).innerHTML = r.inputPlaceholder,
                    dn.appendChild(mn),
                    W(dn);
                    break;
                case "textarea":
                ...
                "select" !== r.input && "radio" !== r.input || (r.inputOptions instanceof Promise ? (n.showLoading(),
                ...
                function(n, t, e) {
                    ...
                    F && !R(s, o.noanimation) ? s.addEventListener(F, function n() {
                        s.removeEventListener(F, n),
                ...
                r.toast || (r.allowEnterKey ? r.focusCancel && Q(M) ? M.focus() : r.focusConfirm && Q(E) ? E.focus() : X(-1, 1) : document.activeElement && document.activeElement.blur()),
                A().scrollTop = 0
            }
            )
        }
    ...
    k.queue = function(n) {
        ...
        return new Promise(function(n, o) {
            !function o(a, s) {
                a < d.length ? (document.body.setAttribute("data-swal2-queue-step", a),
                k(d[a]).then(function(r) {
                    void 0 !== r.value ? (e.push(r.value),
                    o(a + 1, s)) : (t(),
                    n({
                        dismiss: r.dismiss
                    }))
    ...
    k.close = k.closePopup = k.closeModal = k.closeToast = function(n) {
        ...
        if (e) {
            ...
            var a = function() {
                ...
                $([document.documentElement, document.body], [o.shown, o["no-backdrop"], o["has-input"], o["toast-shown"]]),
                Z() && (null !== y.previousBodyPadding && (document.body.style.paddingRight = y.previousBodyPadding,
    ...
    k.setDefaults = function(n) {
        if (!n || "object" !== (void 0 === n ? "undefined" : p(n)))
            return i("the argument for setDefaults() is required and has to be a object");
        b(n);
        for (var t in n)
            k.isValidParameter(t) && (u[t] = n[t])
    }
    ,
    ...
    k.version = "7.2.0",
    k.default = k,
    "undefined" != typeof window && "object" === p(window._swalDefaults) && k.setDefaults(window._swalDefaults);
    var y = {
      ...
      , C = function(n) {
        ...
        $([document.documentElement, document.body], [o["no-backdrop"], o["has-input"], o["toast-shown"]]));
        {
            if (!v()) {
      ...
      , F = function() {
        ...
        for (var e in t)
            if (t.hasOwnProperty(e) && void 0 !== n.style[e])
                return t[e];
        return !1
    }()
      , G = function() {
